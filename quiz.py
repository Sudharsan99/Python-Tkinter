...
def quiz(y):
    ...
    Label(frame1, text="Total keywords in Python ?",font=("Arial",45,"bold")).grid(row=2,column=2)
    ...
    Label(frame2, text="Output of 2**3 ?",font=("Arial",45,"bold")).grid(row=2,column=2)
    ...
    Label(frame3, text="Output of np.arange(1,5) ?",font=("Arial",45,"bold")).grid(row=2,column=2)
    ...
    Button(frame3, text="[0,1,2,3,4,5]",font=("Arial",30,"bold"),bg="light pink",command=a3_wrong).grid(row=3,column=3)

    Label(frame4, text="Keyword used to declare a function ?",font=("Arial",45,"bold")).grid(row=2,column=2)
    ...
    Label(frame5, text="Output of 6//2 ?",font=("Arial",45,"bold")).grid(row=2,column=2)
    Button(frame5, text="3",font=("Arial",30,"bold"),bg="light blue",command=a5_right).grid(row=3,column=1)
    Button(frame5, text="3.0",font=("Arial",30,"bold"),bg="light green",command=a5_wrong).grid(row=3,column=2)
    Button(frame5, text="0.3",font=("Arial",30,"bold"),bg="light pink",command=a5_wrong).grid(row=3,column=3)
...
def a4_right():
    ...
    Label(frame4,text="Marks Obtained: 1",font=("Arial",40,"bold"),background="black",fg="white").grid(row=1,column=2)

def a4_wrong():
    Label(frame4,text="Incorrect",font=("Arial",40,"bold"),background="green",fg="yellow").grid(row=1,column=2)
    Label(frame4,text="Marks Obtained: 0",font=("Arial",40,"bold"),background="black",fg="white").grid(row=1,column=2)
